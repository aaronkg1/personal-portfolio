    ...
    <section className="projects-container" id="projects">
      ...
      <ul className="project-grid">
        <ProjectCard
          ...
          description="Social media app based on the Facebook design built with React, Redux and Firebase."
          url={socialmedia}
          position="left"
        ...
        <ProjectCard
          ...
          description="Where's Wally game with leaderboard built using React and Firebase."
          url={wheresWally}
          position="left"
